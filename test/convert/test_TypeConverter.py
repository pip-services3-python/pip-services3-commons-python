...
class TestTypeConverter:
    ...
    def test_to_type_code(self):
        ...
        # assert TypeCode.Long == TypeConverter.to_type_code(123)
    ...
    def test_to_nullable_type(self):
        ...
        # assert 123 == TypeConverter.to_nullable_type(long, 123.456)
    ...
    def test_to_type(self):
        ...
        # assert 123 == TypeConverter.to_type(long, 123.456)
    ...
    def test_to_type_with_default(self):
        ...
        # assert 123 == TypeConverter.to_type_with_default(long, None, 123)
