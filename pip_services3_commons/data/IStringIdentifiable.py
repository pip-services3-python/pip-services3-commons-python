...
class IStringIdentifiable(IIdentifiable):
    ...
    The interface extends :class:`IIdentifiable` to hardcode id type to string.

    It is a common pattern to use a string GUID as the id, generated by :class:`IdGenerator`.
